...
// Reemplaza "ruta-de-tu-imagen.jpg" con la ruta real de tus imágenes
...
const productos = {
    baja: [
        ...
        { 
            ...
            precio: "$329", 
            color: "rojo",
            imagen: "Assets/mdsperro.png"   // 👈 CAMBIA ESTA RUTA
        },
        { 
            nombre: "SWY Casual", 
            descripcion: "10-15 mmHg · Algodón", 
            precio: "$279", 
            color: "rojo",
            imagen: "Assets/mdrana.png"  // 👈 CAMBIA ESTA RUTA
        }
    ],
    media: [
        { 
            ...
            precio: "$349", 
            color: "morado",
            imagen: "Assets/mdraton.png"     // 👈 CAMBIA ESTA RUTA
        },
        { 
            nombre: "SWY Pulse", 
    ...
    alta: [
        ...
        { 
            ...
            precio: "$429", 
            color: "lima",
             imagen: "../Assets/mdsalien.png"     // 👈 CAMBIA ESTA RUTA
        },
        { 
            nombre: "SWY Elite", 
            descripcion: "20-25 mmHg · Algodón", 
